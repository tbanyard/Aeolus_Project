...
variable = 'Altitude'
variable2 = 'Latitude'
timeseriesplot(X2, Y5, Y6, plottitle = 'Variation in Aeolus\' level altitudes and latitude \n during one full orbit for Rayleigh (QC)', date_form = '%H:%M', minor_date_form = '%M:%S', data_type = 'coda', size = 0.5, color = 'black', marker = '+', variable = variable, variable2 = variable2, legend = 0, l_adj = 0.15, r_adj=0.85)
