...
variable = 'Longitude'
variable2 = 'Latitude'
timeseriesplot(X, Y, Y2, plottitle = 'Variation in Aeolus\' longitude with latitude from 30N-30S', date_form = '%H:%M:%S', minor_date_form = '%M:%S', data_type = 'coda', size = 0.5, color = 'black', marker = '+', variable = variable, variable2 = variable2, legend = 0, l_adj = 0.15, r_adj=0.85)
