...
"""2019 07 01"""
# ~ dbl += 'AE_OPER_ALD_U_N_2B_20190701T083159_20190701T100211_0002.DBL'
# ~ hdr += 'AE_OPER_ALD_U_N_2B_20190701T083159_20190701T100211_0002.HDR'
"""2019 07 11"""
...
# Comment out the 10 lines below to apply validity flags and the 
# cloudy/clear filter
mie_times = mie_date_time
mie_alts = mie_altitude
mie_lats = mie_latitude
mie_lons = mie_longitude
mie_wvs = mie_wind_velocity
rayleigh_times = rayleigh_date_time
rayleigh_alts = rayleigh_altitude
rayleigh_lats = rayleigh_latitude
rayleigh_lons = rayleigh_longitude
rayleigh_wvs = rayleigh_wind_velocity
...
for RG_elmnt in range(len(RG)):
	for t in range(len(rayleigh_times)):
		...
		rayleigh_times[t] >= lastgroupstarttime:
			...
			if np.abs(rayleigh_wvs[t]) < 25000:
...
# ~ plt.legend(loc=9)
plt.savefig('testandesfocus.png',dpi=300)
