...
print(np.shape(x))
print(np.shape(y))
cs1 = plt.pcolormesh(x, y, z, cmap='RdYlBu_r', shading = 'bilinear', alpha=1, zorder=3)
...
print(np.shape(x))
print(np.shape(y))
cs2 = plt.pcolormesh(x, y, z, cmap='RdYlBu_r', shading = 'bilinear', alpha=1, zorder=3)
...
print(np.shape(x))
print(np.shape(y))
cs3 = plt.pcolormesh(x, y, z, cmap='RdYlBu_r', shading = 'bilinear', alpha=1, zorder=3)
...
plt.savefig('CW_QBOplot.png',dpi=300)
