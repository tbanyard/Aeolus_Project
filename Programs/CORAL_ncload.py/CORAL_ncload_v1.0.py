...
filename = '20190725-2110_T120Z900.nc'
...
# Cosmetics
plt.title('CORAL lidar timeseries for 2019-07-26')
...
timerange = data_time[-1] - data_time[0]
# ~ date_intvl = 120
...
# ~ ax1.xaxis.set_minor_locator(plt.MaxNLocator(5)) # Maximum number of date ticks
