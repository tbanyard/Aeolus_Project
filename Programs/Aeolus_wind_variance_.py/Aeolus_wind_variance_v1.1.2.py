...
# Plotting data
map = Basemap(projection='robin',llcrnrlat=-90,urcrnrlat=90,\
...
x, y = map(lons,lats)
cs = plt.pcolormesh(x, y, z, cmap='RdYlBu_r', alpha=1, zorder=3)
...
fig.colorbar(cs, cmap='RdYlBu_r', orientation='horizontal',
